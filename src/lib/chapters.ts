...
export const CHAPTERS: ChapterDefinition[] = [
  {
    ...
    intro:
      "This matcha cafe used to be the coziest spot in town. Tanuki needs your sharp eyes to bring it back.",
    completionText:
      "The Matcha Cafe is glowing again. Tanuki is ready to guide you to the next hidden place.",
    repairs: [
      {
        id: "tatami_floor",
        title: "Fix the Tatami",
        description: "Patch the torn tatami mats so guests can sit comfortably.",
        completedAt: 20,
        beforeEmoji: "🟫",
        afterEmoji: "🌾",
      },
      {
        id: "tea_set",
        title: "Repair the Tea Set",
        description: "Restore the cracked cups and missing saucers.",
        completedAt: 40,
        beforeEmoji: "🥣",
        afterEmoji: "🍵",
      },
      {
        id: "paper_window",
        title: "Mend the Shoji",
        description: "Replace the torn paper window panels.",
        completedAt: 60,
        beforeEmoji: "🪟",
        afterEmoji: "✨",
      },
      {
        id: "fresh_paint",
        title: "Refresh the Walls",
        description: "Give the cafe a warm new coat of paint.",
        completedAt: 80,
        beforeEmoji: "🧱",
        afterEmoji: "🎨",
      },
